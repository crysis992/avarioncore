 ...
 * All Rights Reserved.
 * net.crytec.util.packets.wrapper.WrapperPlayServerSpawnEntity can not be copied and/or distributed without the express
...
public class WrapperPlayServerSpawnEntity extends AbstractPacket {
	...
	// Useful constructor
	private static PacketContainer fromEntity(final Entity entity, final int type,
			final int objectData) {
