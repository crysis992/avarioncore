 ...
 * All Rights Reserved.
 * net.crytec.util.regionevents.RegionLeaveEvent can not be copied and/or distributed without the express
...
public class RegionLeaveEvent extends RegionEvent implements Cancellable {
  ...
  /**
   * sets whether this event should be cancelled when the event is cancelled the player will not be able to move out of the region
   *
