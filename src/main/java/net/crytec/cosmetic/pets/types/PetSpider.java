 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetSpider can not be copied and/or distributed without the express
...
public class PetSpider extends EntitySpider {
  ...
  public PetSpider(final World world, final Player owner) {
