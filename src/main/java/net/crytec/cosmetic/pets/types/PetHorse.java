 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetHorse can not be copied and/or distributed without the express
...
public class PetHorse extends EntityHorse implements EquipablePet {

  public PetHorse(final World world, final Player owner) {
  ...
  public void equipPet() {
    ...
    be.setColor(Color.DARK_BROWN);
    be.setDomestication(be.getMaxDomestication());
    be.setStyle(Style.WHITEFIELD);
    be.setTamed(true);
  }
