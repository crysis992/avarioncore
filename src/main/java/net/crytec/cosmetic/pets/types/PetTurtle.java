 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetTurtle can not be copied and/or distributed without the express
...
public class PetTurtle extends EntityTurtle implements EquipablePet {

  public PetTurtle(final World world, final Player owner) {
    ...
    goalSelector.a(0, new PathfinderGoalLookAtPlayer(this, EntityHuman.class, 5.0F));
    goalSelector.a(1, new PathfinderGoalWalkToOwner(this, 1.55F, owner));
  ...
  protected void initAttributes() {
    ...
    getAttributeInstance(GenericAttributes.MAX_HEALTH).setValue(10.0);
    getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(1.25);
  }
  ...
  public void equipPet() {
    final Turtle bent = (Turtle) getBukkitEntity();
    bent.setHasEgg(false);
  }
