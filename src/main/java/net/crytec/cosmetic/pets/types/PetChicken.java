 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetChicken can not be copied and/or distributed without the express
...
public class PetChicken extends EntityChicken {
  ...
  public PetChicken(final World world, final Player owner) {
