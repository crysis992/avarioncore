 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetPolarBear can not be copied and/or distributed without the express
...
public class PetPolarBear extends EntityPolarBear {

  public PetPolarBear(final World world, final Player owner) {
