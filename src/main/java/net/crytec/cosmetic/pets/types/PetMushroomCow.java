 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetMushroomCow can not be copied and/or distributed without the express
...
public class PetMushroomCow extends EntityMushroomCow {
  ...
  public PetMushroomCow(final World world, final Player owner) {
