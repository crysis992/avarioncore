 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetRabbit can not be copied and/or distributed without the express
...
public class PetRabbit extends EntityRabbit implements EquipablePet {

  public PetRabbit(final World world, final Player owner) {
    ...
    goalSelector.a(2, new PathfinderGoalWalkToOwner(this, 1.6F, owner));
  ...
  public void equipPet() {
    final Rabbit be = (Rabbit) getBukkitEntity();
    be.setRabbitType(Type.SALT_AND_PEPPER);
  }
