 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetEndermite can not be copied and/or distributed without the express
...
public class PetEndermite extends EntityEndermite {
  ...
  public PetEndermite(final World world, final Player owner) {
