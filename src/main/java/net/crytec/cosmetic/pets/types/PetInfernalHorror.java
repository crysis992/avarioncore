 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetInfernalHorror can not be copied and/or distributed without the express
...
public class PetInfernalHorror extends EntityHorse implements EquipablePet {

  public PetInfernalHorror(final World world, final Player owner) {
...
//		super.n();
//
//		if (this.locX != this.lastX || this.locZ != this.lastZ) {
//			ParticleEffect.SMOKE_NORMAL.display(0.65F, 0.35F, 0.65F, 0.15F, 5, bukkitEntity.getLocation(), 20D);
//			ParticleEffect.FLAME.display(0.35F, 0.2F, 0.35F, 0.15F, 2, bukkitEntity.getLocation(), 20D);
//		} else {
//			ParticleEffect.FLAME.display(0.6F, 0.1F, 0.6F, 0, 2, bukkitEntity.getLocation(), 20D);
//		}
//
//	}
