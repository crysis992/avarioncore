 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetPigZombie can not be copied and/or distributed without the express
...
public class PetPigZombie extends EntityPigZombie implements EquipablePet {

  public PetPigZombie(final World world, final Player owner) {
  ...
  public void equipPet() {
    final PigZombie bent = (PigZombie) getBukkitEntity();
    bent.getEquipment().setItemInMainHand(new ItemStack(Material.GOLDEN_SWORD));
    bent.getEquipment().setItemInMainHandDropChance(0F);
  }
