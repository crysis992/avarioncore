 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetSnowman can not be copied and/or distributed without the express
...
public class PetSnowman extends EntitySnowman {

  public PetSnowman(final World world, final Player owner) {
    ...
    goalSelector.a(2, new PathfinderGoalWalkToOwner(this, 2.2F, owner));
  }
