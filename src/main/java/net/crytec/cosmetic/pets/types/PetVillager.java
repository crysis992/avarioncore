 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetVillager can not be copied and/or distributed without the express
...
public class PetVillager extends EntityVillager {
  ...
  public PetVillager(final World world, final Player owner) {
