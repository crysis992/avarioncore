 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetZombie can not be copied and/or distributed without the express
...
public class PetZombie extends EntityZombie implements EquipablePet {

  public PetZombie(final World world, final Player owner) {
  ...
  public void equipPet() {
    final Zombie zombie = (Zombie) getBukkitEntity();
