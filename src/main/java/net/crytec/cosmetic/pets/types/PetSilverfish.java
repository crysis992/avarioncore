 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetSilverfish can not be copied and/or distributed without the express
...
public class PetSilverfish extends EntitySilverfish {
  ...
  public PetSilverfish(final World world, final Player owner) {
