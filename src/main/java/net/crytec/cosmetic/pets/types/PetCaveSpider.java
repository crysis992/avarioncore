 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.pets.types.PetCaveSpider can not be copied and/or distributed without the express
...
public class PetCaveSpider extends EntityCaveSpider {
  ...
  public PetCaveSpider(final World world, final Player owner) {
