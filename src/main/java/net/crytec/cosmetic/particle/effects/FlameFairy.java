 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.particle.effects.FlameFairy can not be copied and/or distributed without the express
...
public class FlameFairy extends IParticleEffect {
  ...
  public FlameFairy(final Player player) {
    super(player);
  ...
  public void onUpdate(final boolean isMoving) {
    ...
    if (d2 > 0.1) {
      ...
      getPlayer().getWorld().spawnParticle(Particle.LAVA, currentLocation, 1, 0.0, 0.0, 0.0, 0.0);
      getPlayer().getWorld().spawnParticle(Particle.FLAME, currentLocation, 1, (double) 0, (double) 0, (double) 0, (double) 0);
