 ...
 * All Rights Reserved.
 * net.crytec.cosmetic.particle.effects.DarkFairy can not be copied and/or distributed without the express
...
public class DarkFairy extends IParticleEffect {
  ...
  public DarkFairy(final Player player) {
    super(player);
  ...
  public void onUpdate(final boolean isMoving) {
    ...
    if (d2 > 0.1) {
      ...
      getPlayer().getWorld().spawnParticle(Particle.SMOKE_LARGE, currentLocation, 1, 0.0, 0.0, 0.0, 0.0);

      getPlayer().getWorld().spawnParticle(Particle.DRAGON_BREATH, currentLocation, 1, (double) 0.05f, (double) 0.05f, (double) 0.05f, (double) 0.05f);
